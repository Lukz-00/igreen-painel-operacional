      ...
      {resultado && (
        <div className="space-y-5">
          <div className="grid grid-cols-4 gap-3">
            ...
            <MetricCard label="Falta nos Recebíveis"  value={resultado.faltaRec.length}                             sub="sem match real"          color="#f59e0b" onClick={() => setAbaAtiva('faltaRec')} />
            <MetricCard label="Só no BKO (sem boleto)" value={(resultado.faltaRecSoBKO||[]).length}               sub="cadastrado, sem boleto"  color="#fb923c" onClick={() => setAbaAtiva('faltaRecSoBKO')} />
            <MetricCard label="UC Divergente"         value={(resultado.faltaRecUCDiv||[]).length}                 sub="UC errada (outros forn.)" color="#a78bfa" onClick={() => setAbaAtiva('faltaRecUCDiv')} />
