...
const SCHEMAS = {
  ...
  boletos_pag: [
    ...
    { key:'legenda',       label:'Legenda',               required:false, aliases:['Legenda','legenda','Observacao','Observacao da fatura'] },
  ...
  boletos_gv: [
    ...
    { key:'fornecedora',     label:'Fornecedora',          required:false, aliases:['fornecedora','Fornecedora','regiao/fornecedora'] },
    { key:'regiao',          label:'Regiao',               required:false, aliases:['regiao','Regiao','Região','regional','Regional','regiao/fornecedora'] },
  ...
  boletos_fat: [
    ...
    { key:'mes',            label:'Competencia / Mes',     required:true,  aliases:['MES DE REFERENCIA','Mes de referencia','Mes referencia','REFER'] },
    { key:'arquivo_origem', label:'Arquivo de Origem',     required:true,  aliases:['ARQUIVO_DE_ORIGEM','ARQUIVO DE ORIGEM','ARQUIVO DO RECEBIMENTO','ARQUIVO DO BOLETO'] },
    { key:'codigo_cliente', label:'Codigo Cliente',        required:false, aliases:['Codigo Cliente','Codigo','CODIGO PARCEIRO','Codigo Parceiro','cod_cliente','IDENTIFICADOR'] },
    { key:'numero_cliente', label:'Numero Cliente',        required:false, aliases:['Numero Cliente','NumeroCliente','N Cliente','UC - ID DO PARCEIRO'] },
    { key:'cpf',            label:'CPF / CNPJ',            required:false, aliases:['CPF/CNPJ','CPF','CNPJ','UC - CPF/CNPJ'] },
    { key:'cliente',        label:'Cliente / Nome',        required:false, aliases:['NOME DO CLIENTE','Cliente','Nome','UC - NOME','NOME PARCEIRO'] },
    { key:'fornecedora',    label:'Fornecedora',           required:false, aliases:['DISTRIBUIDORA','Fornecedora','UC - CONCESSIONARIA'] },
    { key:'status',         label:'Status',                required:false, aliases:['STATUS','STATUS.1','Status','SITUACAO DO DISPARO'] },
    { key:'valor',          label:'Valor',                 required:false, aliases:['VALOR DA FATURA (R$)','VALOR DA FATURA','Valor da Fatura','VALOR LIQUIDO (FATURAMENTO)','VALOR LIQUIDO','TOTAL A PAGAR','VALORPARCELA'] },
    ...
    { key:'emissao',        label:'Data de Emissao',       required:false, aliases:['DATA DE EMISSAO','DATA DE EMISSAO - FATURA NORTEN','Data de emissao'] },
    { key:'codbar',         label:'Codigo de Barras',      required:false, aliases:['CODIGO DE BARRAS','LINHA DIGITAVEL','PIX COPIA E COLA'] },
  ],
  inad_pag: [
